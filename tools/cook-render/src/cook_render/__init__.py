...
def main(argv=None):
    ...
    time_index_html = render_index_by_time(recipe_items)
    (output_dir / 'index_by_time.html').write_text(time_index_html, encoding='utf-8')
